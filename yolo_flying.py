                ...
                if drone_image is not None:
                    ...
                    for i in target_bounded_boxes:
                        ...
                        try:
                            ...
                            image_roi = cv2.inRange(image_roi, np.array([17, 15, 100]), np.array([50, 56, 200]))
                    ...
                    try:
                        ...
                        #print("Thread: NO TARGET! {}\t{}\t{}".format("No", "No", "No"))
                        continue
...
def tracking_target(droneVision, args):
    ...
    while True:
        ...
        direction = q.get()
        print("Main Fn: {}\t{}\t{}".format(direction[0], direction[1], direction[2]))
        if (testFlying):
            drone.fly_direct(roll=0, pitch=direction[0], yaw=direction[1], vertical_movement=direction[2], duration=0.1)
...
if __name__ == "__main__":
    ...
    if (success):
        ...
        droneVision.set_user_callback_function(userVision.detect_target, user_callback_args=None)
